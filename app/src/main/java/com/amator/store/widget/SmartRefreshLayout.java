package com.amator.store.widget;
 ...
 *
 */
public class SmartRefreshLayout extends ViewGroup implements NestedScrollingParent {

    private static final String LOG_TAG = SmartRefreshLayout.class.getSimpleName();
    ...
    public SmartRefreshLayout(Context context, AttributeSet attrs) {
        ...
        try {
            pullDownEnabled = array.getBoolean(R.styleable.SmartRefreshLayout_smart_ui_enable_pull_down, true);
            pullUpEnabled = array.getBoolean(R.styleable.SmartRefreshLayout_smart_ui_enable_pull_up, true);
            mBackground = array.getDrawable(R.styleable.SmartRefreshLayout_smart_ui_background);
        } finally {
            array.recycle();
        }
    ...
    public interface OnChildScrollUpCallback {
        boolean canChildScrollUp(SmartRefreshLayout parent, View child);
    }

    public interface OnChildScrollDownCallback {
        boolean canChildScrollDown(SmartRefreshLayout parent, View child);
    }
}