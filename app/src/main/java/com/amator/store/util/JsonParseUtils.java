...
import com.amator.store.bean.AppBean;
import com.amator.store.bean.AppCommentBean;
import com.amator.store.bean.AppDetailBean;
import com.amator.store.bean.AppIntroductionBean;
import com.amator.store.bean.AppMoreRecommendBean;
import com.amator.store.bean.AppRecommendBean;
import com.amator.store.bean.CategoryBean;
import com.amator.store.bean.CategoryNecessaryBean;
import com.amator.store.bean.CategoryNewBean;
import com.amator.store.bean.CategorySubscribeBean;
import com.amator.store.bean.CategoryToolBean;
import com.amator.store.bean.RecommendBean;
import com.amator.store.bean.TopBean;
